...
public:
    ...
    QPushButton *corrImportButton1;
    QPushButton *corrDeleteButton1;
    QPushButton *corrClearButton1;
    QFrame *line_7;
    ...
    QPushButton *corrImportButton2;
    QPushButton *corrDeleteButton2;
    QPushButton *corrClearButton2;
    QFrame *line_8;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        threadEnableCheckBox = new QCheckBox(centralWidget);
        threadEnableCheckBox->setObjectName(QStringLiteral("threadEnableCheckBox"));
        threadEnableCheckBox->setChecked(true);

        verticalLayout_2->addWidget(threadEnableCheckBox);
        ...
        corrImportButton1 = new QPushButton(centralWidget);
        corrImportButton1->setObjectName(QStringLiteral("corrImportButton1"));
        corrImportButton1->setEnabled(false);

        verticalLayout_6->addWidget(corrImportButton1);
        ...
        corrClearButton1 = new QPushButton(centralWidget);
        corrClearButton1->setObjectName(QStringLiteral("corrClearButton1"));

        verticalLayout_6->addWidget(corrClearButton1);
        ...
        corrImportButton2 = new QPushButton(centralWidget);
        corrImportButton2->setObjectName(QStringLiteral("corrImportButton2"));
        corrImportButton2->setEnabled(false);

        verticalLayout_7->addWidget(corrImportButton2);
        ...
        corrClearButton2 = new QPushButton(centralWidget);
        corrClearButton2->setObjectName(QStringLiteral("corrClearButton2"));

        verticalLayout_7->addWidget(corrClearButton2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        threadEnableCheckBox->setText(QApplication::translate("MainWindow", "Thread Enable", 0));
        ...
        corrImportButton1->setText(QApplication::translate("MainWindow", "Import", 0));
        corrDeleteButton1->setText(QApplication::translate("MainWindow", "Detele", 0));
        corrClearButton1->setText(QApplication::translate("MainWindow", "Clear", 0));
        ...
        corrImportButton2->setText(QApplication::translate("MainWindow", "Import", 0));
        corrDeleteButton2->setText(QApplication::translate("MainWindow", "Delete", 0));
        corrClearButton2->setText(QApplication::translate("MainWindow", "Clear", 0));
